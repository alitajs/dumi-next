        ...
        Object.assign(
          {
            ...
            repository: {
              type: 'git',
              url: 'https://github.com/alitajs/dumi-next',
            },
            authors: [
              'xiaohuoni <xiaohuoni@gmail.com> (https://github.com/xiaohuoni)',
            ],
            license: 'MIT',
            bugs: 'https://github.com/alitajs/dumi-next/issues',
            homepage: `https://github.com/alitajs/dumi-next/tree/master/packages/${opts.pkg}#readme`,
            publishConfig: {
              access: 'public',
            },
          },
