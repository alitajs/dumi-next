...
describe('getRepoUrl', () => {
  it('for github', () => {
    expect(getRepoUrl('git@github.com:umijs/dumi.git')).toEqual(
  ...
  it('for gitlab (specific manually)', () => {
    ...
    expect(
      getRepoUrl(
        'git+https://self.gitlab.com/umijs/subgroup/dumi.git',
        'gitlab',
      ),
    ).toEqual('https://self.gitlab.com/umijs/subgroup/dumi');

    expect(
      getRepoUrl(
        'git+http://self.gitlab.com/umijs/subgroup/dumi.git',
        'gitlab',
      ),
    ).toEqual('http://self.gitlab.com/umijs/subgroup/dumi');
  });
